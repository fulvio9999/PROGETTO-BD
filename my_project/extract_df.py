...
def get_location_info(wban):
    ...
    df_stations = pd.read_csv(r"D:\BACKUP\BACKUP Pen-drive Fulvio\FLV\UNIVERSITA'\MAGISTRALE\UNIVERSITA' 2\1° SEMESTRE\MODELLI E TECNICHE PER BIG DATA\PROGETTO\Dash plotly da web\clima-main\assets\data\2013stationM.csv")
